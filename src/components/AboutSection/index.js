        ...
        <InfoContainer lightBg={false} id='about'>
            ...
            <div className='row'>
                ...
                <div className='col-md-6 col-sm-12' data-aos="fade-left">
                    ...
                    The satisfaction that I get while working and completing every project made me do more and more. And I believe, I have did something creatively. </p>

                    <a className='btn btn-sm btn-success mt-3' rel="noreferrer" href='https://drive.google.com/file/d/1JgHdSei8HoKBn3oX-VcldSqTc-fZ7hgm/view?usp=sharing' target='_blank'>Download <i class="fad fa-download"></i> </a>
                </div>
            </div>
            {/* <InfoWrapper>
               <h2>About</h2> 
